         ...
         <div class="bg-purple-200
          p-10 flex flex-col w-full shadow-xl rounded-xl">
           ...
           <form @submit.prevent="edit" class="w-full">
             ...
             <div id="input" class="flex flex-col w-full my-5">
               <label for="newpassword" class="text-purple-500 mb-2"
                 >newpassword</label
               >
               <input
                 type="password"
             ...
             <div id="input" class="flex flex-col w-full my-5">
               <label for="password_confirmation" class="text-purple-500 mb-2"
   ...
   methods:{
     ...
     edit(){
          ...
          .then(response => {
            ...
            this.$router.push({ name: 'myprofile', params: { dataSuccessMessage: this.successMessage } })
