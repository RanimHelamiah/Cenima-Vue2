       ...
       <div class="max-w-6xl max-h-screen mx-auto m-4 ">
            <form @submit.prevent="snackupdate(showsnack)" class="mb-2 mt-4" enctype="multipart/form-data">
                ...
                <div class="grid xl:grid-cols-2 xl:gap-6">
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="image" name="image" :src="`http://127.0.0.1:8000/${showsnack.image}`" style="width:250px;height:300px;margin-left:20px;" alt="image"/>
                    </div>
                    <div class="relative z-0 mb-6 mt-7 w-full group">
                        ...
                        <button type="submit" class="mt-40 mr-8 ml-8 text-white bg-violet-700 hover:bg-violet-800 
