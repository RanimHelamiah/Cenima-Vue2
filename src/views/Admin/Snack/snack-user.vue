<template>
        ...
        <div id="cart-sidebar" class="min-h-screen bg-purple-300 w-1/3" v-if="!isHidden">
            ...
            <table class="min-w-max w-full table-auto rounded-lg" >
                        <thead>
                            <tr class="bg-violet-900 dark:bg-violet-300  text-md leading-normal text-purple-200 dark:text-purple-900">
                                <th class="py-3 px-6 text-left">Snack_ID</th>
            ...
            <a href="#" class="border border-2 border-violet-400 bg-violet-900 hover:bg-violet-400 text-purple-200
...
<script>
    ...
    export default {
     ...
     addToCart(snack, ammount){
        ...
        blabla.map((bla)=> {
           return [bla.id,bla.ammount]
        })

        console.log(blabla)
        // snack.
        // this.cart.push(snack)
     }
