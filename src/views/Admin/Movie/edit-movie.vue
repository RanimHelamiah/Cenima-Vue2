        ...
        <form @submit.prevent="movieupdate(editmovie)" class="mb-2 mt-4" enctype="multipart/form-data">
         <div v-if="successMessage" class="success-message text-purple-900 darek:text-gray-100">{{ successMessage }}</div>
            ...
            <div class="relative z-0 mb-6 w-full group">
                ...
                <textarea v-model="editmovie.movie.description" name="description" id="description"  style="height:100px;width:100%;"
            ...
            <div class="grid xl:grid-cols-2 xl:gap-6">
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    <input type="text" v-model="editmovie.movie.video" name="video"
                ...
                <div class="relative z-0 mb-6 mt-7 w-full group">
                    ...
                    <input type="file" :src="editmovie.movie.image" @input="image = $event.target.files[0]" name="image" class="block py-2.5 px-0 w-full text-md text-purple-900 bg-transparent border-0 border-b-2 border-purple-300 appearance-none dark:text-white dark:border-purple-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-violet-600 peer" placeholder=" " required />
                </div>             
                <div class="relative z-0 mb-6 w-full group">
		          <select name="hall_id" id="hall_id"
                   ...
                   focus:ring-0 focus:border-violet-600 peer" v-model="editmovie.movie.hall_id" required >
		         	<option value selected disabled>Select Hall</option>
                    <option   v-for="hall in editmovie.halls" :key="hall.id" :value="hall.id">
                       {{ hall.name}}
                    </option>
                 </select>
		        </div>
                <div class="relative z-0 mb-6 w-full group">
		          <select name="type" id="type"
                   ...
                   border-0 border-b-2 border-purple-300 appearance-none dark:text-white 
                   dark:border-purple-600 dark:focus:border-violet-500 focus:outline-none
                   focus:ring-0 focus:border-violet-600 peer" v-model="editmovie.movie.type" required >
                ...
                <div class="relative z-0 mb-6 w-full group">
		          <select name="starttime[]" id="starttime" 
                   ...
                   border-0 border-b-2 border-purple-300 appearance-none dark:text-white 
                   dark:border-purple-600 dark:focus:border-violet-500 focus:outline-none
                   focus:ring-0 focus:border-violet-600 peer" v-model="editmovie.movie_times" required >
		         	<option value selected disabled class="bg-purple-200 dark:bg-purple-900">Select Starttime</option>
                    <option   v-for="time in editmovie.times" :key="time.id" :value="time.id">
                       {{ time.starttime}}
                    </option>
                 </select>
		        </div>
                <div class="relative z-0 mb-6 w-full group">
		          <select name="genre[]" id="genre"
                   ...
                   border-0 border-b-2 border-purple-300 appearance-none dark:text-white 
                   dark:border-purple-600 dark:focus:border-violet-500 focus:outline-none
                   focus:ring-0 focus:border-violet-600 peer" v-model="editmovie.movie_genres" required >
		         	<option value selected disabled class="bg-purple-200 dark:bg-purple-900">Select Genre</option>
                    <option   v-for="genre in editmovie.genres" :key="genre.id" :value="genre.id">
                       {{genre.name}}
                    </option>
                 </select>
		        </div>
            ...
            <div class="mt-4 grid xl:grid-cols-2 xl:gap-6">
                ...
                <div class="relative z-0 mb-6 w-full group">
                    ...
                    <input type="date" v-model="editmovie.movie.to" name="to" id="to" class="block py-2.5 px-0 w-full text-md text-purple-900 bg-transparent border-0 border-b-2 border-purple-300 appearance-none dark:text-white dark:border-purple-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-violet-600 peer"  required />
                </div>
                <div class="relative z-0 mb-6 w-full group">
                  <select name="showing_type" id="showing_type"
                   ...
                   border-0 border-b-2 border-purple-300 appearance-none dark:text-white 
                   dark:border-purple-600 dark:focus:border-violet-500 focus:outline-none
                   focus:ring-0 focus:border-violet-600 peer" v-model="editmovie.movie.showing_type" required >
